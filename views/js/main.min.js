...
function updatePizzaSize() {
    ...
    function changeSliderLabel() {
        switch (latestPizzaSize) {
            ...
            case "3":
                ...
                break;
            default:
                console.log("bug in changeSliderLabel of UpdatePizzaSize function changeSliderLabel")
        }
    }
    ...
    function widthSwitcher() {
        switch (latestPizzaSize) {
            ...
            default:
                console.log("bug in widthSwitcher");
        }
    }
    // Iterates through pizza elements on the page and changes their widths
    function changePizzaSizes() {
        var elements = document.getElementsByClassName("randomPizzaContainer");
        for (numberofElements = elements.length, newWidth = widthSwitcher(), i = 0; numberofElements > i; i++)
            elements[i].style.width = newWidth;
    }
    // User Timing API is awesome
    window.performance.mark("mark_start_resize"), changeSliderLabel(), changePizzaSizes(), window.performance.mark("mark_end_resize"),
...
window.addEventListener("scroll", onScroll), document.addEventListener("DOMContentLoaded", function() {
    for (var cols = 8, b = 256, c = 0; 40 > c; c++) {

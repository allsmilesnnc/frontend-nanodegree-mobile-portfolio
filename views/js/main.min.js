    ...
    function b() {
        switch (latestPizzaSize) {
            case "1":
                return a("Small"), "25%";
            case "2":
                return a("Medium"), "33.33%";
            case "3":
                return a("Large"), "50%";
            default:
                console.log("bug in sizeSwitcher of UpdatePizzaSize function b")
        }
    }
    // Iterates through pizza elements on the page and changes their widths
    function c() {
        for (var a = document.querySelectorAll(".randomPizzaContainer"), c = a.length, d = b(), e = 0; c > e; e++) a[e].style.width = d
    }
...
function updatePositions() {
    ...
    var a, b = document.querySelectorAll(".mover"),
        c = document.body.scrollTop / 1250,
        d = [];
    for (a = 0; a < b.length; a++) {
        var phase = Math.sin(c + a % 5);
        d[a] = b[a].basicLeft + 100 * phase + "px"
    }
    for (a = 0; a < b.length; a++) b[a].style.left = d[a];
